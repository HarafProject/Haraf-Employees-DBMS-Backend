...
const { validate, validateUser, loginValidator, validateEditUser } = require('../middleware/validation');
...
router.put('/profile', auth,validate(validateEditUser), userController.editProfile);
